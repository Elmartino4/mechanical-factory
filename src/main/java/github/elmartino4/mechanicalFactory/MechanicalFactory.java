...
public class MechanicalFactory implements ModInitializer {
	...
	public void onInitialize() {
		...
		generatorMap.put(new GeneratorIdentifier(Fluids.FLOWING_WATER.getDefaultState(), Fluids.EMPTY.getDefaultState(), Blocks.BLUE_ICE.getDefaultState(), null), Blocks.FROSTED_ICE.getDefaultState());
		generatorMap.put(new GeneratorIdentifier(Fluids.WATER.getDefaultState(), Fluids.EMPTY.getDefaultState(), Blocks.BLUE_ICE.getDefaultState(), null), Blocks.ICE.getDefaultState());
	}
}
